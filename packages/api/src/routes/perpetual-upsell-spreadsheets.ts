...
// ============================================================
// Epic 29 Story 29.22 — Planilha de Upsell High Ticket do perpétuo.
// Reusa a tabela funnel_spreadsheets com type='perpetual_upsell' e
// stage_id NULL (1 por funil). Espelha perpetual-spreadsheets.ts.
// ============================================================

const SHEET_TYPE = "perpetual_upsell" as const;
...
// Mesmo mapeamento canônico das outras planilhas de venda. Email + data + status
// são o que o cruzamento precisa; id melhora dedup/pareamento de reembolso.
...
export default fp(async function perpetualUpsellSpreadsheetsRoutes(fastify) {
      ...
      const [row] = await fastify.db
        ...
        .where(
          and(
            ...
            eq(funnelSpreadsheets.type, SHEET_TYPE),
          ),
        )
        .limit(1);
